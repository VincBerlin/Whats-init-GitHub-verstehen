        ...
        <nav className="border-b border-slate-800/60 backdrop-blur-sm sticky top-0 z-50 bg-slate-950/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14 gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-400">
              <Link href="/lernen" className="hidden sm:inline hover:text-slate-200 transition-colors">
                Academy
              </Link>
              <Link href="/wiki/mcp" className="hidden sm:inline hover:text-slate-200 transition-colors">
                Lexikon
              </Link>
              <ThemeToggle />
            </div>
